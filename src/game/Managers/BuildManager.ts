...
export class BuildManager {
	...
	createBuildSpots(basecampDimensions: {
		width: number;
		height: number;
		centerX: number;
		centerY: number;
		...
		const positions = [
			{
				x: basecampDimensions.centerX - halfWidth - cornerOffset,
				y: basecampDimensions.centerY - halfHeight - cornerOffset
			}, // Top-left
			{
				x: basecampDimensions.centerX + halfWidth + cornerOffset,
				y: basecampDimensions.centerY - halfHeight - cornerOffset
	...
	handleBuildAttempt(
		...
		buildSpotSprite: Phaser.GameObjects.GameObject
	) {
