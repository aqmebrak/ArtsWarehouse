...
<!--	&lt;!&ndash; liste des morceaux &ndash;&gt;-->
...
<div class="mt-10 mx-32">
	<div id="list-screen-footer">
		...
		<div class="list-controls">
			<div class="list-previous amplitude-prev" />
			<div class="list-play-pause amplitude-play-pause" />
			<div class="list-next amplitude-next" />
		</div>
	</div>
	<div id="player-progress-bar-container">
		<progress id="song-played-progress" class="amplitude-song-played-progress" />
		<progress id="song-buffered-progress" class="amplitude-buffered-progress" value="0" />
	</div>

	<div id="player-middle">
		<div id="time-container">
			<span class="amplitude-current-time time-container" />
			<span class="amplitude-duration-time time-container" />
		</div>
	...
	<div id="player-bottom">
		...
		<div id="volume-container">
			<img
				src="https://521dimensions.com/img/open-source/amplitudejs/examples/flat-black/volume.svg"
